...
public class ApplicationSpecs(ITestOutputHelper testOutput) : SpecsBase(testOutput)
{
    ...
    [Fact]
    public void The_entry_point_is_generated_when_none_is_defined()
    {
        // Arrange & Act
    ...
    [Fact]
    public void The_entry_point_is_not_generated_when_already_defined()
    {
        // Arrange & Act
        var commands = CommandCompiler.Compile(
            // lang=csharp
        ...
        // Assert
        commands[0]
            .Type.Assembly.EntryPoint?.DeclaringType?.Name.Should()
            .NotBe("AutoGeneratedCommandLineProgram");
    }
}
