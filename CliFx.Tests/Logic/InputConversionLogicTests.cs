...
{
    [TestFixture]
    public class InputConversionLogicTests
    {
        ...
        public void ConvertOptionInput_Test(CommandOptionInput input, Type targetType, object expectedConvertedValue)
        {
            // Act
            var convertedValue = InputConversionLogic.ConvertOptionInput(input, targetType);
        ...
        public void ConvertOptionInput_Negative_Test(CommandOptionInput input, Type targetType)
        {
            // Act & Assert
            Assert.Throws<CliFxException>(
                () => InputConversionLogic.ConvertOptionInput(input, targetType));
        }
    }
}