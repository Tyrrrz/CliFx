...
{
    [Fact]
    public async Task I_can_pass_a_value_to_a_parameter_input()
    {
        // Arrange
    ...
    [Fact]
    public async Task I_can_pass_multiple_values_to_a_sequence_based_parameter_input()
    {
        // Arrange
        var command = CommandCompiler.Compile(
            // lang=csharp
    ...
    [Fact]
    public async Task I_can_pass_nothing_to_a_non_required_parameter_input_to_keep_its_default_value()
    {
        // Arrange
        var command = CommandCompiler.Compile(
            // lang=csharp
    ...
    [Fact]
    public async Task I_can_try_to_pass_nothing_to_a_required_parameter_input_and_get_an_error()
    {
        // Arrange
        var command = CommandCompiler.Compile(
            // lang=csharp
    ...
    [Fact]
    public async Task I_can_try_to_pass_nothing_to_a_required_sequence_based_parameter_input_and_get_an_error()
    {
        // Arrange
        var command = CommandCompiler.Compile(
            // lang=csharp
    ...
    [Fact]
    public async Task I_can_try_to_pass_too_many_values_to_parameter_inputs_and_get_an_error()
    {
        // Arrange
        var command = CommandCompiler.Compile(
            // lang=csharp
