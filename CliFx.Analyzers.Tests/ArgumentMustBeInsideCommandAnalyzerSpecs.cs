...
{
    public class ArgumentMustBeInsideCommandAnalyzerSpecs
    {
        private static DiagnosticAnalyzer Analyzer { get; } = new ArgumentMustBeInsideCommandAnalyzer();
...
public abstract class MyCommand : ICommand
{
    ...
    public ValueTask ExecuteAsync(IConsole console) => default;
        ...
        [Fact]
        public void Analyzer_does_not_report_an_error_on_a_property_that_is_not_an_argument()
        {
            // Arrange
            // language=cs
            const string code = @"
