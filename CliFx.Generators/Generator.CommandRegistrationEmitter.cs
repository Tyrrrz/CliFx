...
public partial class Generator
{
    private static string EmitCommandRegistrations(ImmutableArray<CommandSymbol> commands)
    {
        ...
        $$"""
            ...
            namespace {{KnownSymbols.CommandLineApplicationBuilder.Namespace}};
            ...
            internal static class CommandRegistrations
            {
                ...
                /// </summary>
                internal static {{KnownSymbols.CommandLineApplicationBuilder}} AddCommandsFromThisAssembly(
                    this {{KnownSymbols.CommandLineApplicationBuilder}} builder
                )
                {
                    {{string.Join(
                        Environment.NewLine,
