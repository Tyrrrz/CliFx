...
internal sealed class CliFxReferences(Compilation compilation)
{
    ...
    public TypeDescriptor BoolBindingConverter { get; } =
        new(compilation.GetTypeByMetadataName("CliFx.Infrastructure.Binding.BoolBindingConverter")!);
    public TypeDescriptor DateTimeOffsetBindingConverter { get; } =
        new(compilation.GetTypeByMetadataName("CliFx.Infrastructure.Binding.DateTimeOffsetBindingConverter")!);
    public TypeDescriptor TimeSpanBindingConverter { get; } =
        new(compilation.GetTypeByMetadataName("CliFx.Infrastructure.Binding.TimeSpanBindingConverter")!);
    // Open-generic types — use .GlobalBase when appending concrete type arguments.
    public TypeDescriptor EnumBindingConverter { get; } =
        new(compilation.GetTypeByMetadataName("CliFx.Infrastructure.Binding.EnumBindingConverter`1")!);
    public TypeDescriptor NullableBindingConverter { get; } =
        new(compilation.GetTypeByMetadataName("CliFx.Infrastructure.Binding.NullableBindingConverter`1")!);
    public TypeDescriptor ConvertibleBindingConverter { get; } =
        new(compilation.GetTypeByMetadataName("CliFx.Infrastructure.Binding.ConvertibleBindingConverter`1")!);
    public TypeDescriptor DelegateBindingConverter { get; } =
        new(compilation.GetTypeByMetadataName("CliFx.Infrastructure.Binding.DelegateBindingConverter`1")!);
    public TypeDescriptor ArraySequenceBindingConverter { get; } =
        new(compilation.GetTypeByMetadataName("CliFx.Infrastructure.Binding.ArraySequenceBindingConverter`1")!);
    public TypeDescriptor ArrayInitializableSequenceBindingConverter { get; } =
        new(compilation.GetTypeByMetadataName("CliFx.Infrastructure.Binding.ArrayInitializableSequenceBindingConverter`2")!);
    // ────────────────────────────────────────────────────────────────────────
    /// <summary>
